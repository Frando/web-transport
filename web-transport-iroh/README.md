...
# Usage
To use web-transport-quinn, first you need to create a [iroh::Endpoint](https://docs.rs/quinn/latest/quinn/struct.Endpoint.html); see the documentation and examples for more information.
...
```rust
    ...
    let mut endpoint = iroh::Endpoint::client("[::]:0".parse()?)?;
